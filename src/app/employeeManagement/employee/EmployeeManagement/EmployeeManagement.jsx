        ...
        return (
          <div className="none_wrap">
            <Tooltip title="Cập nhật diễn biến" className="pr-10">
              <IconButton
                size="small"
                onClick={() => handleOpenDialogUpdate(rowData, "update")}
              >
            ...
            <Tooltip title="Xem thông tin">
              <IconButton
                size="small"
                onClick={() => handleOpenDialogUpdate(rowData, "watch")}
              >
